...
???
As an uninvited guest twice over in the countries I have called home, I acknowledge the Indigenous peoples whose traditional lands I have lived and learned on. I grew up on, and then returned to, Canada and the traditional lands of the Anishinaabeg, the Haudenosaunee, and the Mississaugas of the Credit. Moving to Aotearoa, I lived first in Waipā and then Tāmaki Mākaurau. I will continue to work to be a better tangata Tiriti, honouring my duties to the places and peoples that helped createp me.
...
The Crown is in breach of its obligations under .purple[**te Tiriti o Waitangi**] with respect to health outcomes for Māori. Redressing disparities in SEP is fundamental to health equity obligations.
...
???
A longitudinal perspective that considers socioeconomic influences across arcs of people’s lives may have different implications for interventions enhancing equity in the face of persistent disparities in mortality outcomes between ethnic groups. 
...
Calculations of the **a**rea **u**nder the ROC **c**urve (AUC) indicate how well the model classifies, specificially: if you were to randomly select two individuals, one who died and one who didn't, how likely would the model be to correctly order them so the individual who did die has a higher predicted probability.
]
...
Lower SEP is consistently significantly associated with higher mortality. 
<br><br>
However, most of the life-course hypothesis and SEP indicator combinations across adulthood I tested do not improve classification of mortality outcomes. 
<br><br>
Where they do, measures of SEP at a single point directly before mortality follow-up are sufficient.
</div>


???
- Most experiences receiving welfare or living in a low-income household were associated with higher mortality, regardless of timing or pattern of exposure. 
- However, life-course hypotheses with adulthood SEP did not generally improve classification of mortality outcomes beyond what could be achieved with demographic variables alone. 
- In the one case where there was an improvement in classification, only SEP before the mortality follow-up window was needed to be approximately as effective at classification as having full knowledge of an individual’s SEP experiences at three points over 25 years. (welfare receipt, 55–64 at the census before mortality follow-up).
- For individuals consistently in the labour force across adulthood, lower occupational status was not as strongly associated with mortality as welfare and household income.
...
- Logistic regression with interactions between ethnicity and all other variables
- Use the original data and a 'cross-world' version of the data where, counterfacutally, Māori have European covariate distributions to predict age adjusted mortality rates for Māori, Europeans and 'cross-world' Māori
...
???
- Sex patterns consistent with a pattern observed by Blakely et al. (2018) with SEP indicators measured at the census immediately before mortality follow-up
- Specifically, that for males, this bias may underestimate the extent of SEP mediation. 
...
???
After pairwise comparison adjustments, not sig differences for Māori. Became religious not significant (after pairwise and adjustment for health).
...
???
Pacific people, the most religiously affiliated of the four main ethnic groupings.

Tracking affiliation longitudinally over 10 years for Māori, Asian and Pacific New Zealanders, there were no significant associations for religiosity, though the relatively small number of observations in each trajectory may have limited detection of any differences.
...
Religion implications: 
  - This is a pattern that has been seen generally with health outcomes for Asian New Zealanders (Woodward & Blakely, 2015)
- and would be an interesting instance of this relationship with a social and cultural capital indicator. To my knowledge, the mechanism for this association is not well established for any large population, especially where religious affiliation is associated with higher odds of mortality instead of being protective e.g., due to a specific diet in a small subgroup (Shatenstein & Ghadirian, 1998). 

Weights: Researchers using the NZLC should considered appropriateness for their aims and methods, especially in reporting simple regressions and counts. Failure to account for linkage bias appropriately may result in overestimates of mortality.
...
???
Area under the curve (AUC), which you may also hear referred to as the *c*-statistic can be too conservative. I chose it for our purposes partially due to it's high conservatism. Other approaches could and should certainly be considered in future directions, but my understanding if NRI is that its sensitivity is potentially too risky to be a cornerstone for making claims from.
...
## .lightpurple[<i class="fa-solid fa-table"></i>] Data: Missing data
